...
export default function Navbar() {
  ...
  useClickAway(profileDropdownRef, () => setProfileDropdownOpen(false));
                ...
                <>
                  ...
                  >
                    <div>
                      <button
                        type="button"
                        className="inline-flex w-full justify-center rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-100"
                        id="menu-button"
                        aria-expanded="true"
                        aria-haspopup="true"
                        onClick={() =>
                      ...
                      >
                        <Avatar imageUri={session.user.image} />
  ...
  --> */}
                    {profileDropdownOpen && (
                      <div
                        className="absolute right-0 mt-4 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
                        role="menu"
                      ...
                      >
                        ...
                        <div className="py-1" role="none">
                          <form method="POST" action="#" role="none">
                            <button
                              type="submit"
                              className="block w-full px-4 py-2 text-left text-sm text-gray-700 hover:bg-indigo-500 hover:text-white"
                              role="menuitem"
                              tabIndex={-1}
                              id="menu-item-3"
                              onClick={() => signOut()}
